...
source=("HandBrake::git+https://github.com/kentooo/HandBrake.git#branch=preview" "HandBrake-SVT-AV1-HDR::git+https://github.com/kentooo/HandBrake-SVT-AV1-PSYEX.git#branch=handbrake-svt-av1-hdr")
